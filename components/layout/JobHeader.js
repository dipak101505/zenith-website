            ...
            <div className="row align-items-center">
              ...
              <div className="col-xl-7 col-lg-7 col-sm-6 col-6">
                ...
                <nav className="main-nav" ref={navToggle}>
                  ...
                  <ul>
                    ...
                    <li className="has-child-menu">
                      ...
                      <ul className="sub-menu">
                        ...
                        <li>
                          <Link href="/about/Behampore" legacyBehavior>
                            <a>Behampore</a>
                          </Link>
                        </li>
                  ...
                  <div className="menu-btn-wrap d-block d-lg-none">
                    <Link href="/" legacyBehavior>
                      <a className="menu-reg" href="#">
                        Register
                      </a>
                    </Link>
                    <Link href="/" legacyBehavior>
                      <a className="common-btn btn-style-1" href="#">
                        Sing In
                      </a>
                    </Link>
                  </div>
              ...
              <div className="col-xl-3 col-lg-3 d-none d-lg-block">
                <div className="menu-btn-wrap">
                  <Link href="/" legacyBehavior>
                    <a className="menu-reg">Register</a>
                  </Link>
                  <Link href="/" legacyBehavior>
                    <a className="common-btn btn-style-1">Sing In</a>
                  </Link>
                </div>
              </div>
            </div>
