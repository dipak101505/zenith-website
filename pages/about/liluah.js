...
const Services = () => {
  return (
    <>
    <Head>
        <title>Zenith Liluah – Top Coaching for NEET, JEE, Foundation</title>
        <meta name="description" content="Located in Liluah, Howrah – Zenith offers NEET, IIT-JEE, Robotics & Foundation coaching with expert faculty and dedicated support."/>
        <meta name="keywords" content="Liluah coaching, IIT NEET Liluah, Zenith Liluah, Robotics training Liluah, Foundation coaching Liluah, Howrah coaching"/>
      ...
      <header>
        <Header />
        <BreadCrumb pagename="Zenith Liluah" />
      </header>
      <SolutionArea />
      <AboutFutured />
      <CoreTeacher/>
