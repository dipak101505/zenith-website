                    ...
                    <div className="footer-logo">
                      ...
                      >
                        <ul>
                          <li>
                            <Link
                              href={FooterConstant.GoogleLink}
                              legacyBehavior
                            >
                              <a>
                          ...
                          <li>
                            <Link
                              href={FooterConstant.LinkedinLink}
                              legacyBehavior
                            >
                              <a>
                          ...
                          <li>
                            <Link
                              href={FooterConstant.FacebookLink}
                              legacyBehavior
                            >
                              <a>
                          ...
                          <li>
                            <Link
                              href={FooterConstant.TwitterLink}
                              legacyBehavior
                            >
                              <a>
                          ...
                          <li>
                            <Link
                              href={FooterConstant.InstagramLink}
                              legacyBehavior
                            >
                              <a>
                ...
                <div className="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-6">
                  <div className="single-widget">
                    ...
                    <div className="footer-link">
                      <ul>
                        <li>
                          <Link href="/about/saltlake">Saltlake</Link>
                        </li>
                        <li>
                ...
                <div className="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-6">
                  <div className="single-widget">
                    ...
                    <div className="contact-info">
                      <ul>
                        <li>
                          <a href="tel:+919051509444">
                            Call : <span>9051509444</span>
                          </a>
                        </li>
                        <li>
                          <a href="mailto:zenithinsti@gmail.com">
                            Email : <span>zenithinsti@gmail.com</span>
                          </a>
                        </li>
                        <li>
                          Address : <span>India</span>
                        </li>
                      </ul>
                    </div>
                  </div>
