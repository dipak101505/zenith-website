              ...
              <div className="error-404-content text-center">
                ...
                <div className="error-404-text">
                  ...
                  <p className="error-description mb-5">
                    ...
                    the digital wilderness. Don't worry though - even the best
                ...
                <div className="error-404-actions">
                  <Link href="/" className="common-btn btn-style-1 me-3 mb-3">
                ...
                <div className="error-404-links mt-5">
                  ...
                  <div className="quick-links-grid">
                    <Link href="/IITJEE" className="quick-link-item">
                      <i className="bi bi-mortarboard"></i>
                      <span>IIT JEE</span>
                    </Link>
                    <Link href="/NEET" className="quick-link-item">
                      <i className="bi bi-heart-pulse"></i>
                      <span>NEET</span>
                    </Link>
                    <Link href="/foundation" className="quick-link-item">
                      <i className="bi bi-building"></i>
                      <span>Foundation</span>
                    </Link>
                    <Link href="/olympiad" className="quick-link-item">
