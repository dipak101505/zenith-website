...
const Services = () => {
  return (
    <>
    <Head>
        <title>Best Coaching in Fatehpur – SIP-Amrit Vidya Ashram | Zenith Institute</title>
        <meta name="description" content="Zenith Institute SIP-Amrit Vidya Ashram, Fatehpur – Premier coaching for IIT-JEE, NEET, Foundation, and Robotics in Shekhawati, Rajasthan."/>
        <meta name="keywords" content="Fatehpur coaching, SIP-Amrit Vidya Ashram, IIT JEE Fatehpur, NEET Fatehpur, Robotics classes Fatehpur, Zenith Institute Fatehpur, Foundation course Rajasthan, Shekhawati coaching"/>
      ...
      <header>
        <Header />
        <BreadCrumb pagename="Zenith SIP-Amrit Vidya Ashram" />
      </header>
      <SolutionArea />
      <AboutFutured />
      <HwhTeacher/>
