...
const Services = () => {
  return (
    <>
    <Head>
        <title>Zenith Saltlake - Best Coaching Institute in Kolkata for IITJEE | NEET | WBJEE |Foundation |AI & Robotics </title>
      ...
      <SolutionArea 
        title="Welcome to Zenith <span>Saltlake</span>"
        image="/assets/images/about/Saltlake.png"
        description="Zenith Saltlake "
      />
      <AboutFutured />
      <CoreTeacher/>
      {/* <ServicePricing /> */}
