            ...
            <div className="row align-items-center">
                ...
                <nav className="main-nav" ref={navToggle}>
                  ...
                  <ul>
                    <li className="has-child-menu">
                      ...
                      <ul className="sub-menu">
                        <li>
                          <Link
                            href="https://lms-eight-chi.vercel.app"
                            legacyBehavior
                          >
                            <a>Online Course</a>
                          </Link>
                        ...
                        <li>
                          <Link
                            href="https://zenithinstitute.theonlinetests.com/"
                            legacyBehavior
                          >
                            <a>Online Test</a>
                          </Link>
                    ...
                    <li>
                      <Link href="/results" legacyBehavior>
                        <a className={isActive("/results")}>Results</a>
                      </Link>
                    </li>
                    {/* <li className="has-child-menu">
                    ...
                    <li className="has-child-menu">
                      <Link href="/about" legacyBehavior>
                        <a className={isActive("/about/howrah")}>Our Centers</a>
                      </Link>
                      <i className="fl" onClick={ToggleSubMenu}>
                        +
                      </i>
                  ...
                  <div className="menu-btn-wrap d-block d-lg-none">
                    <Link
                      ...
                      legacyBehavior
                    >
                      <a className="common-btn btn-hrrd-2">Courses</a>
                    </Link>
                    <Link
                      href="https://zenithinstitute.theonlinetests.com/"
                      legacyBehavior
                    >
                      <a className="common-btn btn-hrrd-1">Tests</a>
                    </Link>
                  </div>
                </nav>
              </div>
              <div className="col-xxl-3 col-xl-4 col-lg-3 d-none d-lg-block">
                <div className="menu-btn-wrap">
                  <Link href="https://lms-eight-chi.vercel.app" legacyBehavior>
                    <a className="common-btn btn-hrrd-2">Courses</a>
                  </Link>
                  <Link
                    href="https://zenithinstitute.theonlinetests.com/"
