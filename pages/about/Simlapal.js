...
const Services = () => {
  return (
    <>
    <Head>
        <title>Zenith Simlapal - Bankura – Top Coaching for NEET, JEE, Foundation</title>
        <meta name="description" content="Located in Simlapal - Bankura – Zenith offers NEET, IIT-JEE, Robotics & Foundation coaching with expert faculty and dedicated support."/>
        <meta name="keywords" content="Simlapal coaching, Bankura coaching, IIT NEET Simlapal, Zenith Simlapal, Robotics training Bankura, Foundation coaching Simlapal"/>
